...
export class IdealService {
    ...
    constructor(
        ...
        private _adminUrl: AdminApiService,
    ...
    start() {
       ...
       _idle.idle = this._sharedService.getSharedData('appProperties').sessionTimeOut;
       _idle.timeout = 1;
       ...
       this.userIdle.setConfigValues(_idle);
        ...
        this.userIdle.onTimeout().subscribe(() => {
            ...
            this._adminUrl.logout(cookieVal[2]).subscribe(
                success => {
                    ...
                    window.location.href = `${this._sharedService.getSharedData('appProperties').protocol}://${this._sharedService.getSharedData('appProperties').host}:${this._sharedService.getSharedData('appProperties').appPort}/connect_ui/#/login`;
                },
                error => {
