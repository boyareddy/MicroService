...
public class ResultMessageSenderTest {
	...
	public void setUp() throws HL7Exception{
        ...
        Mockito.when(MainApp.getFilepath("AcknowledgeTxt")).thenReturn("AcknowledgementMessages.txt");
        Mockito.when(MainApp.getFilepath("NoOfSSU")).thenReturn("2");
	...
	@Test
	public void runTest() throws HL7Exception, LLPException, IOException {
		try {
            resultMessageSender.run(new HL7Client(), null);
