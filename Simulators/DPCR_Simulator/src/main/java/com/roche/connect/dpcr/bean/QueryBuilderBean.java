package com.roche.connect.dpcr.bean;

public class QueryBuilderBean {
	...
	private String delayBetweenQuery;
	...
	/**
	 * @return the delayBetweenQuery
	 */
	public String getDelayBetweenQuery() {
		return delayBetweenQuery;
	}

	/**
	 * @param delayBetweenQuery
	 *            the delayBetweenQuery to set
	 */
	public void setDelayBetweenQuery(String delayBetweenQuery) {
