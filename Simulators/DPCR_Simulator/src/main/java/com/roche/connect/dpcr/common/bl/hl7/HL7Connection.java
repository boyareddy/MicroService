...
import com.roche.connect.dpcr.sim.bl.EnumSampleStatus;
import com.roche.connect.dpcr.sim.bl.SampleRepository;
...
public class HL7Connection  {
	...
	private String host = MainApp.getValueFromPropFile("HostName");
	private int port = Integer.parseInt(MainApp.getValueFromPropFile("HostPort"));
