...
public interface MessageSender {
    void run(HL7Client client,EnumSampleStatus sampleStatus) throws ParseException, LLPException, NumberFormatException, InterruptedException, IOException;
    void run(HL7Client client,SampleRepository samples,EnumSampleStatus sampleStatus) throws NumberFormatException, InterruptedException, IOException;
