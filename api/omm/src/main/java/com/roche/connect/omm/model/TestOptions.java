...
@Entity
@Table(name = "ORDER_TEST_MAPPING")
@JsonIgnoreProperties("order")
@EntityListeners({ AuditingEntityListener.class })
public class TestOptions implements MultiTenantEntity,AuditableEntity{

	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name = "test_options_sequence", sequenceName = "test_options_sequence")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "test_options_sequence")
	@Column(name = "ORDER_TEST_TABLE_ID")
	private long id;
