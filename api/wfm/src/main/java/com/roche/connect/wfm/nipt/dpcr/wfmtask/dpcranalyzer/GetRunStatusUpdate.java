 ...
 *
 */
public class GetRunStatusUpdate implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) {
	    logger.info("dPCR Analyzer GetRunStatusUpdate Received");
	    try {
            logger.info(" -> execute()::dPCR Analyzer ESU" + execution.getProcessInstanceId());
            ...
            if (activityProcessData == null) {
                throw new HMTPException("Execution variable activityProcessData cannot be null for GetRunStatusUpdate");
            }
            ...
            logger.error(" -> execute()::GetRunStatusUpdate ::dpcr analyzer UpdateResults " + e);
        }
        logger.info(" <- execute():GetRunStatusUpdate::updatedPCRAnalyzerProcess" + execution.getProcessInstanceId());
    }
