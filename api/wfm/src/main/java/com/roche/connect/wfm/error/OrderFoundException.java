/*******************************************************************************
 * OrderFoundException.java Version: 1.0 Authors: somesh_r *********************
 ...
 * implementation to handle Order Found Exception. *********************
 ******************************************************************************/
...
/**
 * Exception class implementation to handle Order Found Exception.
 */
@Provider public class OrderFoundException extends Exception implements ExceptionMapper<OrderFoundException> {
    private static final long serialVersionUID = -3936995808842487407L;
    
    public OrderFoundException() {
    }
    
    public OrderFoundException(String string) {
    }
    
    @Autowired public ErrorResponse errorResponse;
    
    @Override public Response toResponse(OrderFoundException exception) {
