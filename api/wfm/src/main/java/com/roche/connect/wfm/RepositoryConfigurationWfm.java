 ...
 * 
 * 
 *  RepositoryConfigurationWfm.java                  
 *  Version:  1.0
 * 
 *  Authors:  somesh_r
 * 
 ...
 * *********************
 * 
 *  Description: Class implementation to configure JPA Repositories.
 * 
 * *********************
 * 
 * 
...
/**
 * Class implementation to configure JPA Repositories. 
 *
 */
@Configuration
public class RepositoryConfigurationWfm {
//For Multitenant    
    
	 @EnableJpaRepositories(basePackages = {"com.roche.connect.wfm.writerepository"}, 
	    ...
	    static class JPAMultiTenantWriteRepositoryConfiguration {}
	     ...
	     @EnableJpaRepositories(basePackages = {"com.roche.connect.wfm.repository"}, 
	            entityManagerFactoryRef = "entityManagerFactory", 
	            transactionManagerRef = "transactionManager", 
