 ...
 *  from COMPANY.  Access to the source code contained herein is hereby forbidden to anyone except current COMPANY employees, managers or contractors who have been
 ...
 * *********************
 * 
 *  Description: Class implementation to send MP24 ACK Response message to IMM.
 * 
 * *********************
 * 
 * 
...
/**
 * Class implementation to send MP ACK message to IMM.
 *
 */
public class SendMp24ACKResponse implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) {
		try {
			logger.info(" -> execute()::Send MP24 SendMp24ACKResponse");
			...
			logger.error(" -> execute()::Mp24 ACK error code " + e);
		}
		logger.info(" <- execute()::Send MP24 ACK");
	}
}
