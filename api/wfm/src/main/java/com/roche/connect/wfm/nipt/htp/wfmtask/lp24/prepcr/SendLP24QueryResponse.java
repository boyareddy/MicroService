 ...
 * *********************
 * 
 *  Description: Class implementation to send LP24 Pre Pcr query Response.
 * 
 * *********************
 * 
 * 
...
/**
 * Class implementation to send LP24 Pre Pcr query Response.
 *
 */
public class SendLP24QueryResponse implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) {
		try {
			logger.info("Enter LP24 PrePCRQBP");
			 activityProcessData = (ActivityProcessDataDTO) execution
		            ...
		            responseRenderingService.duplicateOrderQueryPositiveResponseforLp24(containerId, deviceId, accessioningId, activityProcessData);
		} catch (HMTPException e) {
			logger.error(" -> execute()::Error occurred, ", e);
		}
	logger.info("Sent Query Response Successfully to LP24 PREPCR Preparation");
