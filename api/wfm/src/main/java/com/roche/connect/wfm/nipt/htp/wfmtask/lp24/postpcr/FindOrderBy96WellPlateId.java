/*******************************************************************************
 * FindOrderBy96WellPlateId.java Version: 1.0 Authors: somesh_r
 ...
 * to find Order by 96 Well PlateId. *********************
 ******************************************************************************/
...
/**
 * Class implementation to find Order by 96 Well PlateId.
 */
public class FindOrderBy96WellPlateId implements JavaDelegate {
    
    private HMTPLogger logger = HMTPLoggerFactory.getLogger(this.getClass().getName());
    
    @Override public void execute(DelegateExecution execution) {
        logger.info("End of finding Accessioning Id for FindOrderBy96WellPlateId ");        
    }
