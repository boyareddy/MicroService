...
public class Lp24SeqPrepQueryITTest {

	String jsonContent = "";
	public static final String jsonForSucessWfmCreation = "src/test/java/resource/Lp24SeqPrepQueryPositive.json";
	public static final String jsonForFailureWfmCreation = "src/test/java/resource/Lp24SeqPrepQueryNegative.json";
	...
	@Test(priority = 1)
	public void PositiveLp24SeqPrepQuerTest() throws IOException {
		...
		//Assert.assertEquals(statusCode, 200, "wfm has recieved Lp24SeqPrep-qbp successfully");

	}

	@Test(priority = 2)
	public void NegativeLp24SeqPrepQuerTest() throws IOException {
		...
		//Assert.assertNotEquals(statusCode, 200, "wfm Error occured while receiving Lp24SeqPrep-qbp");
