...
public class Lp24PostPcrStatusITTest {

	String jsonContent = "";
	public static final String jsonForSucessWfmCreation = "src/test/java/resource/Lp24PostPcrStatusPositive.json";
	public static final String jsonForFailureWfmCreation = "src/test/java/resource/Lp24PostPcrStatusNegative.json";
	...
	@Test(priority = 1)
	public void PositiveLp24PostPcrStatusTest() throws IOException {
		...
		//Assert.assertEquals(statusCode, 200, "wfm has recieved Lp24PostPcr-u03 successfully");

	}

	@Test(priority = 2)
	public void NegativeLp24PostPcrStatusTest() throws IOException {
		...
		//Assert.assertNotEquals(statusCode, 200, "wfm Error occured while receiving Lp24PostPcr-u03");
