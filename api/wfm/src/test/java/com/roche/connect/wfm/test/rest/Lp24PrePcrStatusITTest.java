...
public class Lp24PrePcrStatusITTest {

	String jsonContent = "";
	public static final String jsonForSucessWfmCreation = "src/test/java/resource/Lp24PrePcrStatusPositive.json";
	public static final String jsonForFailureWfmCreation = "src/test/java/resource/Lp24PrePcrStatusNegative.json";
	...
	@Test(priority = 1)
	public void positiveLP24PrePcrStatusTest() throws IOException {
		...
		//Assert.assertEquals(statusCode, 200, "wfm has recieved Lp24PrePcr-u03 successfully");

	}

	@Test(priority = 2)
	public void NegativeLP24PrePcrStatusTest() throws IOException {
		...
		//Assert.assertNotEquals(statusCode, 200, "wfm Error occured while receiving Lp24PrePcr-u03");
