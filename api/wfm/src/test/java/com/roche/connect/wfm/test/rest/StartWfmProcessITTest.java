...
public class StartWfmProcessITTest {
	private String host = "";
    private String port = "";
	...
	String jsonContent = "";
	public static final String jsonForSucessWfmCreation = "src/test/java/resource/StartWfmSucessCommon.json";
	public static final String jsonForFailureWfmCreation = "src/test/java/resource/StartWfmFailureCommon.json";
	...
	@Test(priority = 1)
	public void PositiveMp24QueryTest() throws IOException {
	...
	@Test(priority = 2)
	public void NegativeMp24QueryTest() throws IOException {
