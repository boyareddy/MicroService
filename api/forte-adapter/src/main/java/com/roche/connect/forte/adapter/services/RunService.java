...
public interface RunService {
	...
	public Response getPatientDetails(String htpComplexId, Cycle cycle, String string);

	public ForteJob getForteJob(Cycle cycle);

	public Response updateJobStatus(String done, String secondary, String complexId);
