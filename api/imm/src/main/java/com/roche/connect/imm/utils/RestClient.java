...
public class RestClient {
	...
	public static <T> T post(String url, Entity entity, List<Object> providers, Class<T> responseType)
		...
		return post(url, entity, null, providers, responseType);
	}
	
	public static <T> T post(String url, Entity entity, String token, List<Object> providers, Class<T> responseType)
			throws UnsupportedEncodingException {
