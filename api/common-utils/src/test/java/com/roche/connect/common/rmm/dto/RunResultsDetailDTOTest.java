...
public class RunResultsDetailDTOTest {

	private com.roche.connect.common.rmm.dto.RunResultsDetailDTO classUnderTest;

	@BeforeTest
	public void setUp() {
		classUnderTest = new com.roche.connect.common.rmm.dto.RunResultsDetailDTO();
	}
	...
	@Test
	public void testGetSetRunResultsDetailsId() {
		long[] testStringArray = { -100, 0, 100 };
		for (int i = 0; i < testStringArray.length; i++) {
			classUnderTest.setRunResultsDetailsId(testStringArray[i]);
			Assert.assertEquals(new Long(testStringArray[i]), new Long(classUnderTest.getRunResultsDetailsId()),
					"Getter and Setter Method Test failed for RunResultsDetailsId");
		}
	}
