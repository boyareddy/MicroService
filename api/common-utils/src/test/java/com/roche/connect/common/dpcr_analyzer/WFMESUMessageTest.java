...
public class WFMESUMessageTest {
	
	private com.roche.connect.common.dpcr_analyzer.WFMESUMessage classUnderTest;

	@BeforeTest
	public void setUp() {
		classUnderTest = new com.roche.connect.common.dpcr_analyzer.WFMESUMessage();
	}
