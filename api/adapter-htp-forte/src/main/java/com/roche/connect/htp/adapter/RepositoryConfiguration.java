...
public class RepositoryConfiguration {
	...
	@EnableJpaRepositories(basePackages = {
			"com.roche.connect.htp.adapter" }, entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager", repositoryFactoryBeanClass = PasJpaSimpleWriteRepositoryFactoryBean.class)
	 ...
	 */
	@EnableJpaRepositories(basePackages = {
			"com.roche.connect.htp.adapter" }, entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager", repositoryFactoryBeanClass = PasJpaSimpleReadRepositoryFactoryBean.class)
