...
public class RepositoryConfiguration {
	...
	// For Multi-tenant repository
	@EnableJpaRepositories(basePackages = {"com.roche.connect.adm.writerepository"}, 
    ...
    static class JPAMultiTenantWriteRepositoryConfiguration {}
     ...
     @EnableJpaRepositories(basePackages = {"com.roche.connect.adm.repository"}, 
            entityManagerFactoryRef = "entityManagerFactory", 
            transactionManagerRef = "transactionManager", 
